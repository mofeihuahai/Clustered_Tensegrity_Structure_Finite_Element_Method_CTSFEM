function [w_t,dnb_t,dnb_d_t,dnb_dd_t,dz_a_t]=tenseg_ex_force_membrane(tspan,a,b,type,gravity,acc,C,M_p,c_index,amplitude,period)
...
%       w_0=-0.5*kron(abs(C)'*mass,[1;1;1]*dz_a_t);        %load in c_index
        w_0=-M_p*kron(ones(size(C,2),1),[1;1;1]*dz_a_t);        %load in c_index
