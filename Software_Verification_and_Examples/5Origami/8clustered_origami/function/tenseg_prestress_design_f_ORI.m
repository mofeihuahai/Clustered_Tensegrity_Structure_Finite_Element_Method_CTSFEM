function [q_c,t_c,q,t]=tenseg_prestress_design_f_ORI(S,l,l_c,A_co_a,V2,w0a,index_gp,fd)
...
% qd=fd./l_d;
z=(e_d'*V2)\(fd-e_d'*(pinv(A_co_a)*w0a));   %self-stress coefficient
%%
t_c=pinv(A_co_a)*w0a+V2*z;
q_c=l_c.\t_c;
t=S'*t_c;
q=l.\t;
