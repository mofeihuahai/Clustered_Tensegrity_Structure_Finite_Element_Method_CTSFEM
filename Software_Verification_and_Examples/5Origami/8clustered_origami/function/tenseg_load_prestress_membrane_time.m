function [w_t,dnb_t,l0_tc_t,l0_l_t,Ia,Ib]=tenseg_load_prestress_membrane_time(substep,ind_w,w0,ind_dn,dn0,ind_l0_tc,dl0_tc,l0_tc,ind_l0_l,dl0_l,l0_l,b,gravity,acc,C,M_p)
...
%% rest length
dl0_i_tc=zeros(size(l0_tc));
dl0_i_tc(ind_l0_tc)=dl0_tc;
dl0_tc_t=dl0_i_tc*linspace(0,1,substep);
l0_tc_t=dl0_tc_t+l0_tc*linspace(1,1,substep);

dl0_i_l=zeros(size(l0_l));
dl0_i_l(ind_l0_l)=dl0_l;
dl0_t=dl0_i_l*linspace(0,1,substep);
l0_l_t=dl0_t+l0_l*linspace(1,1,substep);
