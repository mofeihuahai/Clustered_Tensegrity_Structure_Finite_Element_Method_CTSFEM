function tenseg_video_ori_membrane(n_t,C_b,C_s,C_l,C_h,C_rh,Ca,axislim,num,name,savevideo,R3Ddata)
...
%         tenseg_plot(N,C_b,C_s,99,[],[],[],R3Ddata);hold on
        tenseg_plot_ori_membrane(N,C_b,C_s,C_l,C_h,C_rh,hf,[],[],[],[],Ca);
        view(30,30);
        set(gcf,'color','w');
        axis(axislim)
           axis off
