function [w_t,l0_t_t,l0_l_t]=tenseg_load_prestress_CTS_ORI(tspan,ind_w,w,type,ind_dl0_t,dl0_t,l0_t,ind_dl0_l,dl0_l,l0_l,gravity,acc,C,M_p)
...
%   end
% 
%   l0_t=l0_t+l0_c*linspace(1,1,substep);
%   l0_ct = l0_t;
%% inital angle
