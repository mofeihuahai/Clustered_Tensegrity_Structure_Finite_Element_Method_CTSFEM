function [fig_out] = tenseg_plot_ori_membrane( N,C_b,C_s,C_l,C_h,C_rh,fig_handle,highlight_nodes,view_vec, PlotTitle, R3Ddata,Ca)
...
LineWidth = 3; % Width of panel lines
