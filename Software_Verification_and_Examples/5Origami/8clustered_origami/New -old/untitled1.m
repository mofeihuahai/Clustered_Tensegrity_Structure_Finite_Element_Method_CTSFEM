...
ind_dnb=[]; dnb0=[];
ind_dl0_tc=[1,2,3]; dl0_tc=[-29,-29,-29];
ind_dl0_l=[];dl0_l=[];
...
ind_du=[10,11,12,13,14,15,16,17,18]; du=[0,-0.1,0.1,0,0.1,0,0,0,-0.1];  %变形

% ind_du=[10,11,12,13,14,15,16,17,18]; du=[1,-0.1,0.1,1,0.1,0,1,0,-0.1];  %变形＋平移
