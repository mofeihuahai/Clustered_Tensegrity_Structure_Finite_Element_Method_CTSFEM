...
P_org=[0;0;0];  %局部坐标到整体左坐标的距离
width=0.1;
N=[25.9808,-25.9808,-1.2859e-14,-1.2859e-14;15,15,-30,-30;0,0,0,-30];       %nodal coordinate
...
%% Boundary constraints
 pinned_X=[1,2,4]'; pinned_Y=[1,2,4]'; pinned_Z=[1,2,4]';
...
% input data
data.N=N; data.C=C; data.C_l=C_l;data.C_t=C_t;data.C_pl_bar=C_pl_bar;data.U_t=U_t;data.R=R;data.D1=D1;
...
sigma_l=data_out1.sigma_out;    %sigma_l
