...
width=0.1;
N=width*[1,3,1,3,0,2,4,1;0,0,2,2,2-sqrt(3),2-sqrt(3),2-sqrt(3),2-2*sqrt(3);0,0,0,0,0.05,0.1,0.05,0.05];       %nodal coordinate
...
%% Boundary constraints
 pinned_X=[1,2,3,4]'; pinned_Y=[1,2,3,4]'; pinned_Z=[1,2,3,4,5,7,8]';
...
k_h=1e-1*1/12*E_c(index_h).*l(index_h)*thick^3;
...
% theta_0=pi*ones(n_h,1);     % initial angle of hinge
 theta_0=[pi;pi;pi;0.1;pi]; % initial angle of hinge
...
plot_mode_ori(V_mode_sort,omega_sort,N,Ia,[],[],C_h,C_rh,l,'natrual vibration',...
